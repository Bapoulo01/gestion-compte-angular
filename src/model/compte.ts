...
export class Compte {
    public constructor(
        ...
        public dateBlocage?: string, // Date de blocage, optionnelle si le compte n'est pas bloqué// Durée de blocage en jours, optionnelle si le compte n'est pas bloqué
    ) {
    }
